...
class Book PROTOBUF_FINAL :
 ...
 public:
  ...
  // int32 pages = 2;
  void clear_pages();
  ::PROTOBUF_NAMESPACE_ID::int32 pages() const;
  void set_pages(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_pages() const;
  void _internal_set_pages(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 pages_;
  float price_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Book::_internal_pages() const {
  return pages_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Book::pages() const {
  // @@protoc_insertion_point(field_get:Book.pages)
  return _internal_pages();
}
inline void Book::_internal_set_pages(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  pages_ = value;
}
inline void Book::set_pages(::PROTOBUF_NAMESPACE_ID::int32 value) {
